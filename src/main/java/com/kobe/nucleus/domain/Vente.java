...
public class Vente implements Serializable {
	...
	public Vente dateMVT(LocalDate dateMVT) {
	...
	public Vente createdBy(Utilisateur utilisateur) {
	...
	public String toString() {
		return "Vente{" + "id=" + getId() + ", createdAt='" + getCreatedAt() + "'" + ", updatedAt='" + getUpdatedAt()
				+ "'" + ", dateMVT='" + getDateMVT() + "'" + ", status='" + getStatus() + "'" + ", natureVente='"
				+ getNatureVente() + "'" + ", typeVente='" + getTypeVente() + "'" + ", refVente='" + getRefVente() + "'"
				+ ", numTicket='" + getNumTicket() + "'" + ", tauxremise=" + getTauxremise() + ", montantVente="
				+ getMontantVente() + ", montantTva=" + getMontantTva() + ", montantNet=" + getMontantNet()
				+ ", montanRemise=" + getMontanRemise() + ", valeurMarge=" + getValeurMarge() + ", avoir='" + isAvoir()
				+ "'" + ", montantPaye=" + getMontantPaye() + ", montantRestant=" + getMontantRestant() + ", montantTp="
				+ getMontantTp() + ", montantClient=" + getMontantClient() + ", montantVerse=" + getMontantVerse()
				+ ", montantRendu=" + getMontantRendu() + ", refBon='" + getRefBon() + "'" + ", avoidAmount="
				+ getAvoidAmount() + "}";
	}
}
