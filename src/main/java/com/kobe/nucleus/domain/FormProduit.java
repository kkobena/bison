...
public class FormProduit implements Serializable {
    ...
    public FormProduit code(String code) {
        this.code = code;
        return this;
    }
    ...
    public FormProduit addProduit(Produit produit) {
        this.produits.add(produit);
        produit.setForme(this);
        return this;
    }

    public FormProduit removeProduit(Produit produit) {
        this.produits.remove(produit);
        produit.setForme(null);
        return this;
    }
