...
/**
 * REST controller for managing {@link com.kobe.nucleus.domain.Banque}.
 */
@RestController
@RequestMapping("/api")
public class BanqueResource {
     ...
     */
    @PutMapping("/banques")
    public ResponseEntity<BanqueDTO> updateBanque(@RequestBody BanqueDTO banqueDTO) throws URISyntaxException {
