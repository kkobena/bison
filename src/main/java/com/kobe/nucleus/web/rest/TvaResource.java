...
/**
 * REST controller for managing {@link com.kobe.nucleus.domain.Tva}.
 */
@RestController
@RequestMapping("/api")
public class TvaResource {
     ...
     */
    @PutMapping("/tvas")
    public ResponseEntity<TvaDTO> updateTva(@Valid @RequestBody TvaDTO tvaDTO) throws URISyntaxException {
