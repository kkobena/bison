...
@RestController
@RequestMapping("/api/nucleus-kafka")
public class NucleusKafkaResource {

    private final Logger log = LoggerFactory.getLogger(NucleusKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NucleusKafkaResource(KafkaProperties kafkaProperties) {
