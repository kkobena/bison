...
/**
 * REST controller for managing {@link com.kobe.nucleus.domain.Laboratoire}.
 */
@RestController
@RequestMapping("/api")
public class LaboratoireResource {
     ...
     */
    @GetMapping(value = "/laboratoires",params = {"search"} )
    public ResponseEntity<List<LaboratoireDTO>> getAllLaboratoires(@RequestParam(value = "search") String search, Pageable pageable) {
