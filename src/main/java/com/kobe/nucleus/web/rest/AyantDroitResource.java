...
public class AyantDroitResource {
	 ...
	 *         body the new ayantDroitDTO, or with status {@code 400 (Bad Request)}
	 *         if the ayantDroit has already an ID.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	@PostMapping("/ayant-droits")
	public ResponseEntity<AyantDroitDTO> createAyantDroit(@Valid @RequestBody AyantDroitDTO ayantDroitDTO)
		...
		try {
			...
			return ResponseEntity
					.created(new URI("/api/ayant-droits/" + result.getId())).headers(HeaderUtil
	 ...
	 *         the updated ayantDroitDTO, or with status {@code 400 (Bad Request)}
	 *         if the ayantDroitDTO is not valid, or with status
	 *         {@code 500 (Internal Server Error)} if the ayantDroitDTO couldn't be
	 *         updated.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	@PutMapping("/ayant-droits")
	public ResponseEntity<AyantDroitDTO> updateAyantDroit(@Valid @RequestBody AyantDroitDTO ayantDroitDTO)
			throws URISyntaxException {
		...
		try {
			...
			return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME,
					ayantDroitDTO.getId().toString())).body(result);
		} catch (Exception e) {
	 ...
	 * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
	 *         the ayantDroitDTO, or with status {@code 404 (Not Found)}.
	 */
