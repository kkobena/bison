 ...
 */
@Mapper(componentModel = "spring", uses = {MagasinMapper.class, UserMapper.class, ClientMapper.class, AyantDroitMapper.class, RemiseMapper.class, ModePaiementMapper.class, MedecinMapper.class})
